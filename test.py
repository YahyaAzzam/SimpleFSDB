...
class Test(unittest.TestCase):
    ...
    def test_set(self):
        ...
        set_command("csed25", "Seats", "1.json", "Last_name", "goda").execute()
        set_command("csed25", "Seats", "1.json", "ReservationId", "123").execute()
        x = get_command("csed25", "Seats", "1.json").execute()
    ...
    def test_set_NewFile(self):
        ...
        set_command("csed25", "Seats", "2.json", "Last_name", "goda").execute()
        set_command("csed25", "Seats", "2.json", "ReservationId", "123").execute()
        x = get_command("csed25", "Seats", "2.json").execute()
        ans = {'Last_name': 'goda', 'ReservationId': '123'}
        self.assertEqual(x, ans)
    ...
    def test_deleteFiles(self):
        ...
        delete_command("csed25", "Seats", "1.json").execute()
        delete_command("csed25", "Seats", "2.json").execute()
