import sys
import os
sys.path.append(os.path.join(os.getcwd().replace("testds", ''), "src", "input_adaptors"))
sys.path.append(os.path.join(os.getcwd().replace("testds", ''), "src", "commands"))
sys.path.append(os.path.join(os.getcwd().replace("testds", ''), "src", "output"))
from input import *
