...
VERSION = '0.0.0'
DESCRIPTION = 'Querio is a Python library and tool for managing and querying JSON-based file system databases (FSDB). ' \
...
setup(
    ...
    package_data={'Querio': ['*.json', '*.py']},
    include_package_data=True,
    license="MIT",
    entry_points={
        "console_scripts": ['Querio = Querio.__main__:main']
    },
    ...
    keywords=['DB', 'json', 'Querio', 'File System', 'FSDB', 'simpleFSBD'],
    classifiers=[
